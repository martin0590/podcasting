...
const EmblaCarousel = ({ fansLikeDetail }: CarouselProps) => {
  ...
  const slides = fansLikeDetail && fansLikeDetail?.
    filter((item: any) => item.totalPodcasts > 0)
      ...
      <div className='flex'>
        {slides.slice(0, 5).map((item) => (
          ...
          >
            ...
            />
            <div className='glassmorphism_black relative z-10 flex flex-col rounded-b-xl p-4'>
